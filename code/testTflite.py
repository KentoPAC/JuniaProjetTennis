...
model_path = "../code/mobilenet_v2_1.0_224_quant_edgetpu.tflite"  # Remplace par le chemin vers ton modèle TFLite
...
# Charger la vidéo
video_path = "../Vidéos/VideoBallV2.mp4"  # Remplace par le chemin de ta vidéo
...
while cap.isOpened():
    ...
    # Vérifier le type de données attendu par le modèle
    if input_details[0]['dtype'] == np.uint8:
        input_image = np.uint8(input_image)  # Convertir en UINT8 si nécessaire
    else:
